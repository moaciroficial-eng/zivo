          ...
          <div className="bg-zinc-900 border border-zinc-800 sm:rounded-2xl rounded-t-2xl w-full max-w-lg h-[85vh] sm:h-[75vh] flex flex-col shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-3 shrink-0">
              <input
                ...
                className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-2.5 text-sm placeholder-zinc-500 outline-none focus:border-violet-500 [color-scheme:dark]"
              />
            </div>
                  ...
                  {fotoItens.map(it => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative text-left rounded-xl overflow-hidden border transition ${sel ? 'border-violet-500 ring-2 ring-violet-500/40' : 'border-zinc-800 hover:border-zinc-600'}`}
                      >
            ...
            <div className="p-3 border-t border-zinc-800 flex items-center gap-2 shrink-0">
              ...
              <button
                ...
                className="flex-1 text-sm font-semibold bg-violet-600 hover:bg-violet-500 disabled:opacity-40 disabled:cursor-not-allowed rounded-lg py-2.5 transition cursor-pointer"
              >
