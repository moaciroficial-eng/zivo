...
Regras gerais:
- "categoria" deve ser exatamente: "camiseta", "blusa", "camisa", "polo", "regata", "calca", "bermuda", "tenis", "chinelo" ou "outros"
  - Use "polo" para camisetas polo (com gola e botões)
  - Use "blusa" para blusas femininas
  - Use "camisa" para camisas sociais, camisas masculinas com botões (ex: "CAMISA MC", "CAMISA SOCIAL", "CAMISA XADREZ")
  - Use "camiseta" para camisetas básicas, t-shirts sem botões
