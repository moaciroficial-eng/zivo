...
const IconCopy   = () => <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
...
export default function EstoqueClient({
  ...
  function handleCSVChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    reader.onload = async (ev) => {
      ...
      const validCats = ['camiseta', 'blusa', 'camisa', 'regata', 'calca', 'bermuda', 'polo', 'tenis', 'chinelo', 'outros']
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-5">
          <div className="flex items-center gap-1 bg-zinc-900 border border-zinc-800 rounded-xl p-1">
            {(['todos', 'camiseta', 'blusa', 'camisa', 'polo', 'regata', 'calca', 'bermuda', 'tenis', 'chinelo', 'outros'] as Categoria[]).map(cat => (
              <button
                key={cat}
